...
var elements = {
    ...
    sath: {
        ...
        value: "0",
        type: "select",
        items: [{ key: 0, value: "تراز در سطح" }, { key: 1, value: "تراز تا سطح" }],
        caption: "نوع تراز",
    },
    amount: {
        element: null,
    ...
    cust: {
        id: d_cust,
        type: "Select_Entesab",
        caption: modeGru == 0 ? 'خریداران/فروشندگان' : modeGru == 1 ? 'خریداران' : 'فروشندگان',
        keyField: 'Code',
        keyCaption: 'Name',
        baseValue: {
            ace: ace,
...
var object = $('<div style="background-color: white;padding: 10px;">');
$("#objectBase").append(object);

var create = elements.meliCode;
object.Input(
    {
        ...
        Create: function (e, record) {
            create.element = record.input[0];
        },
        Change: function (e, record) {
            elements.meliCode.value = record.value;
        },
    },
);
...
object.Input(
    {
        ...
        Change: function (e, record) {
            elements.amount.value = record.value;
        },
    },
);
...
object.Input(
    {
        ...
        Change: function (e, record) {
            elements.price.value = record.value;
        },
    },
);


var object = $('<div style="background-color: white;padding: 10px;width:200px">');
$("#objectBase").append(object);

var create = elements.sath;
object.ComboBox(
    {
        caption: create.caption,
        items: create.items,
        ...
        Change: function (e, record) {
            elements.sath.value = record.value;
        },
    },
);
...
var create = elements.kala;
object.Select(
    {
        id: create.id,
        caption: create.caption,
        baseValue: create.baseValue,
        keyField: create.keyField,
        keyCaption: create.keyCaption,
        param: { withimage: null, updatedate: null, Mode: 0, KalaCode: '' },
        Select: function (e, record) {
            elements.kala.value = record;
        },
    }
);
...
var object = $('<div style="background-color: white;padding: 10px;">');
$("#objectBase").append(object);
var create = elements.cust;
object.Select_Entesab(
    {
        id: create.id,
        caption: create.caption,
        baseValue: create.baseValue,
        keyField: create.keyField,
        keyCaption: create.keyCaption,
        param: { forSale: 0, updatedate: null, Mode: modeGru, CustCode: '' },
        Select: function (e, record) {
            elements.cust.value = record;
        },
    }
);
...
object.Select_Entesab(
    {
        ...
        selected: [{ "code": "باطل", "name": "" }, { "code": "موقت", "name": "" }],
        Select: function (e, record) {
            elements.status.value = record;
        },
    }
);
...
object.DatePicker(
    {
        ...
        defult: "1384/01/20",
        Create: function (e, record) {
            var input = record.input[0];
            var btn = record.btn[0];
        },
    },
);
*/
...
/*
$("#objectReport").Report_TrzAcc({
    caption: "تراز حساب ها",
    rprtId: "TrzAcc",
    baseValue: {
        ace: ace,
        group: group,
...
object.DatePicker(
    {
        ...
        Change: function (e, record) {
            elements.azTarikh.value = record.value;
        },
    },
);
...
object.DatePicker(
    {
        ...
        Change: function (e, record) {
            elements.taTarikh.value = record.value;
        },
    },
);
*/
...
var object = $('<div id="widget_TaTarikh" style="background-color: white;padding: 10px;">');
$("#objectBase").append(object);

$("#widget_TaTarikh").DatePicker(
    {
        caption: 'تا تاریخ',
        defult: "1384/12/11",
    }
...
var object = $('<div id="widget_TaTarikh1" style="background-color: white;padding: 10px;">');
$("#objectBase").append(object);

$("#widget_TaTarikh1").DatePicker(
    {
        caption: 'تا تاریخ',
        defult: "1384/12/11",
    }
...
var object = $('<div id="widget_Inv" style="background-color: white;padding: 10px;">');
$("#objectBase").append(object);
...
var object = $('<div id="widget_KGru" style="background-color: white;padding: 10px;">');
$("#objectBase").append(object);
...
var object = $('<div id="widget_CGru" style="background-color: white;padding: 10px;">');
$("#objectBase").append(object);
...
$("#widget_CGru").Select(
    {
        id: d_cGru,
        caption: modeGru == 0 ? 'گروه خریداران/فروشندگان' : modeGru == 1 ? 'گروه خریداران' : 'گروه فروشندگان' ,
        baseValue: {
            ace: ace,
            group: group,
            sal: sal
...
var object = $('<div id="widget_Cust" style="background-color: white;padding: 10px;">');
$("#objectBase").append(object);
...
var object = $('<div id="widget_Opr" style="background-color: white;padding: 10px;">');
$("#objectBase").append(object);
...
var object = $('<div id="widget_Mkz" style="background-color: white;padding: 10px;">');
$("#objectBase").append(object);
...
var object = $('<div id="widget_Status" style="background-color: white;padding: 10px;">');
$("#objectBase").append(object);
...
var columns = [
    { name: 'Code', caption: 'کد', type: type_Code },
    { name: 'Name', caption: 'نام', type: type_Farsi },
    { name: 'FanniNo', caption: 'شماره فنی', type: type_En },
    { name: 'Spec', caption: 'ملاحظات', type: type_Farsi },
]
...
var listModeDesktop = [
    ...
    { value: "TrzAcc", text: "تراز حساب" },
    { value: "Dftr", text: "دفتر حساب" }
]
